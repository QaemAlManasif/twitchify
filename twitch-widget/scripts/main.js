...
const ICUE_MIRROR = [
  ["statsPlace", "statsPlace", "str", "panel"],
  ["feedPlace", "feedPlace", "str", "panel"],
  ["actionsPlace", "actionsPlace", "str", "off"],
  ["customPlace", "customPlace", "str", "off"],
  ["syncChannel", "syncChannel", "bool", true],
  ["layout", "layout", "str", "side"],
  ["buttonSize", "buttonSize", "str", "md"],
  ["selectedStyle", "selectedStyle", "str", "border"],
  ["showQuickActions", "showQuickActions", "bool", true],
  ["qaLabels", "qaLabels", "bool", true],
  ["showComposer", "showComposer", "bool", true],
  ["showViewers", "showViewers", "bool", false],
  ["showTabsInChat", "showTabsInChat", "bool", false],
  ["channelSwitcher", "channelSwitcher", "bool", true],
  ["splitAddOnClick", "splitAddOnClick", "bool", true],
  ["jumpLatest", "jumpLatest", "bool", true],
  ["emoteSuggest", "emoteSuggest", "bool", true],
  ["showFollowed", "showFollowed", "bool", true],
  ["followedOnlyLive", "followedOnlyLive", "bool", true],
  ["watchSync", "watchSync", "bool", false],
  ["preloadWatched", "preloadWatched", "bool", false],
  ["followActiveTab", "followActiveTab", "bool", false],
  ["badgeStyle", "badgeStyle", "str", "images"],
  ["density", "density", "str", "cosy"],
  ["fontSize", "fontSize", "num", 14],
  ["clock", "clock", "str", "12"],
  ["showTimestamps", "showTimestamps", "bool", false],
  ["showChannelAvatar", "showChannelAvatar", "bool", true],
  ["showChatAvatars", "showChatAvatars", "bool", false],
  ["sharedChatSource", "sharedChatSource", "bool", true],
  ["thirdPartyEmotes", "thirdPartyEmotes", "bool", true],
  ["alertMentions", "alertMentions", "bool", true],
  ["alertKeywords", "alertKeywords", "text", ""],
  ["alertSound", "alertSound", "str", "off"],
  ["inlineModActions", "inlineModActions", "bool", false],
  ["confirmBan", "confirmBan", "bool", true],
  ["confirmInlineActions", "confirmInlineActions", "bool", false],
  ["confirmRow", "confirmRow", "bool", true],
  ["confirmQuickActions", "confirmQuickActions", "bool", false],
  ["showAutomod", "showAutomod", "bool", false],
  ["automodNotices", "automodNotices", "bool", true],
  ["accent", "twAccent", "color", "#9146ff"],
  ["bg", "twBackground", "color", "#0a0a0c"],
  ["transparency", "twTransparency", "num", 0],
  ["scrollbars", "scrollbars", "bool", true],
];
